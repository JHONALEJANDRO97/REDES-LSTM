...
DATOS = read_excel('tasa representativa.xlsx',sheet = '2016')
...
particion <- initial_time_split(DATOS, prop = 0.9)
...
DATA = data.frame(cbind(yt,xt,y1,y2,y3,y7,y12))

form = yt~xt+y1+y2+y3+y7
...
data_pred = 1/data_pred

setwd("C:/Users/alejo/Desktop/Tesis/resultados")

write.csv(data_pred, "pred_tmr")
