# -*- coding: utf-8 -*-
"""
Created on Mon Jan 17 14:48:11 2022
...
datos = pd.ExcelFile('Inflacion nacional.xlsx').parse()
...
os.chdir('C:/Users/alejo/Desktop/Tesis/Imagenes documento/Metodologia/Inflacion')
plt.plot(datos_ts)
plt.savefig("inflacion_ts.pdf")
...
pred_data = pd.read_csv("pred_inflacion")
...
os.chdir('C:/Users/alejo/Desktop/Tesis/Imagenes documento/Metodologia/Inflacion')
fig.savefig("inflacion_resul.pdf")
