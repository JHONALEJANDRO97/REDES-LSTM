# -*- coding: utf-8 -*-
"""
Created on Mon Jan 17 11:56:00 2022
...
datos = pd.ExcelFile('Consumo Gas.xlsx').parse()
...
os.chdir('C:/Users/alejo/Desktop/Tesis/Imagenes documento/Metodologia/Gas')
plt.plot(datos_ts)
plt.show()
plt.savefig("gas_ts.pdf")
...
pred_data = pd.read_csv("pred_gas")
