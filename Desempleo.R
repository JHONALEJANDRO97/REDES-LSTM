...
DATOS = read_excel('Tasas de ocupación y desempleo.xlsx')
...
particion <- initial_time_split(DATOS, prop = 0.8)
...
write.csv(data_pred, "pred_desempleo")
