# -*- coding: utf-8 -*-
"""
Created on Sun Jan 16 11:52:41 2022
...
datos = pd.ExcelFile('Demanda energetica nacional.xlsx').parse()
...
os.chdir('C:/Users/alejo/Desktop/Tesis/Imagenes documento/Metodologia/Energetica')
plt.plot(datos_ts)
plt.show()
plt.savefig("energia_ts.pdf")
...
pred_data = pd.read_csv("pred_energetica")
