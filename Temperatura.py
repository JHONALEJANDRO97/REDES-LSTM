# -*- coding: utf-8 -*-
"""
Created on Mon Jan 17 13:53:20 2022
...
datos = pd.ExcelFile('Temperatura media bogota .xlsx').parse()
datos['Fecha']=pd.to_datetime(datos['Fecha'])

datos = datos.set_index('Fecha')
datos_ts = datos['Valor']
datos_ts = datos_ts.asfreq(freq="MS")
...
# plot_acf(datos_ts,adjusted=False,lags=120,title='ACF Demanda Temperatura')
# plot_acf(dif_datos_ts.dropna(),adjusted=False,lags=120,title='ACF Serie Demanda Temperatura Diferenciada')
# plot_acf(dif2_datos_ts.dropna(),adjusted=False,lags=120,title='ACF Serie Demanda Temperatura sin Tendencia y ciclo')

os.chdir('C:/Users/alejo/Desktop/Tesis/Imagenes documento/Metodologia/Temperatura')

plt.plot(datos_ts)
plt.savefig("temperatura_ts.pdf")
...
pred_data = pd.read_csv("pred_temperatura")
...
os.chdir('C:/Users/alejo/Desktop/Tesis/Imagenes documento/Metodologia/Temperatura')
fig.savefig("temperatura_resul.pdf")
