# -*- coding: utf-8 -*-
"""
Created on Mon Jan 17 15:05:19 2022
...
datos = pd.ExcelFile('Tasa representativa.xlsx').parse()
...
dif2_datos_ts=dif_datos_ts.diff(periods=7)
...
os.chdir('C:/Users/alejo/Desktop/Tesis/Imagenes documento/Metodologia/TMR')
plt.plot(datos_ts)
plt.savefig("tmr_ts.pdf")
...
ax5.plot(dif2_datos_ts);ax5.set_title('Diferenciacion de 7st orden')

ax6 = f.add_subplot(326)
plot_acf(dif2_datos_ts.dropna(),ax=ax6,adjusted=False,lags=60,title='ACF Diferenciacion 1st y 7st')



f.savefig("tmr_acf.pdf")
...
pred_data = pd.read_csv("pred_tmr")
