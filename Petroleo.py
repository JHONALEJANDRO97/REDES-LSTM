...
datos = pd.ExcelFile('ExpPetro.xlsx').parse()
...
os.chdir('C:/Users/alejo/Desktop/Tesis/Imagenes documento/Metodologia/Petroleo')
plt.plot(datos_ts)
...
pred_data = pd.read_csv("pred_petroleo")
...
pred_GAM = pred_data['GAM']-1200000
...
os.chdir('C:/Users/alejo/Desktop/Tesis/Imagenes documento/Metodologia/Petroleo')
fig.savefig("petroleo_resul.pdf")
