# -*- coding: utf-8 -*-
"""
Created on Mon Jan 17 10:36:49 2022
...
datos = pd.ExcelFile('Consumo Carbon.xlsx').parse()
...
# plot_acf(datos_ts,adjusted=False,lags=120,title='ACF Demanda carbon')
# plot_acf(dif_datos_ts.dropna(),adjusted=False,lags=120,title='ACF Serie Demanda carbon Diferenciada')
# plot_acf(dif2_datos_ts.dropna(),adjusted=False,lags=120,title='ACF Serie Demanda carbon sin Tendencia y ciclo')
 

os.chdir('C:/Users/alejo/Desktop/Tesis/Imagenes documento/Metodologia/Carbon')
plt.plot(datos_ts)
plt.show()
plt.savefig("carbon_ts.pdf")
...
pred_data = pd.read_csv("pred_carbon")
